...
class NotificationManager {
    ...
    static func scheduleNotification(userData: UserData){
        ...
        content.body = userData.body ?? "" //body = notes
        ...
        if let reminderTime = userData.time {
            let reminderTimeDataComponents = reminderTime.dateComponents
            dateComponents.hour = reminderTimeDataComponents.hour
            dateComponents.minute = reminderTimeDataComponents.minute
        }
